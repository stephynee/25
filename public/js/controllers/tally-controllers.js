...
app.controller('singleTallyCtrl', ['$rootScope', 'tallyDataFactory', function($rootScope, tallyDataFactory) {
  const vm = this;
  let id;
...
app.controller('addTallyCtrl', ['$rootScope', 'tallyFactory', 'colorFactory', 'tallyDataFactory', function($rootScope, tallyFactory, colorFactory, tallyDataFactory) {
  const vm = this;
...
app.controller('editTallyCtrl', ['$rootScope', 'colorFactory', 'tallyFactory', 'tallyDataFactory', function($rootScope, colorFactory, tallyFactory, tallyDataFactory) {
  const vm = this;
...
app.controller('taskTimerCtrl', ['$rootScope', 'timerFactory', function($rootScope, timerFactory) {
  const vm = this;
...
app.controller('taskDataCtrl', ['$rootScope', 'taskDataFactory', function($rootScope, taskDataFactory) {
  const vm = this;
  let taskId;
