...
app.controller('loginCtrl', ['$rootScope', 'authFactory', function($rootScope, authFactory) {
  const vm = this;
...
app.controller('registerCtrl', ['$rootScope', 'authFactory', function($rootScope, authFactory) {
  const vm = this;
...
app.controller('authCtrl', ['$rootScope', 'authFactory', function($rootScope, authFactory) {
  const vm = this;
  let loggedIn;
